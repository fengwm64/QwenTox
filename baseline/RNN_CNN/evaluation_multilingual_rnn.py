...
MODEL_PATH = os.path.join(BASE_DIR, "baseline/RNN_CNN/results_RNN/models/toxic_comment_model")

# Parameters (Must match training configuration in RNN.py)
MAX_FEATURES = 20000
MAX_LEN = 256
...
def load_tokenizer():
    ...
    # In RNN.py, the tokenizer is fitted on both train and test texts.
    ...
    # Initialize Tokenizer with the same parameters as in RNN.py
...
def main():
    ...
    if not os.path.exists(MODEL_PATH):
        ...
        print("Please ensure you have trained the RNN model and it is saved in the correct location.")
        return
